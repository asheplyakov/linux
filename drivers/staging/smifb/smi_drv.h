...
#if defined(CONFIG_DRM_SMIFB_EDMA) && defined(CONFIG_DRM_SMIFB_PRIME)
#error "DRM_SMIFB_EDMA and DRM_SMIFB_PRIME can't be enabled simultaneously"
#endif
...
#define SUPPORT_CHIP " \
\t\tSM750, SM768\n"
#define SUPPORT_XVERSION " \
\t\tUbuntu 16.04.3 LTS\
\t\tDebian 9\n"

#define _version_	"1.2.3.0"
