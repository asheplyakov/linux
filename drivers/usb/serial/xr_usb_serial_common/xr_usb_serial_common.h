...
struct reg_addr_map {
	...
	unsigned int    uart_rx_fifo_reset;
	unsigned int    uart_tx_fifo_reset;
};
...
#define UART_GPIO_MODE_SEL_RS485       	 0x3
#define UART_GPIO_MODE_RS485_POL	   	 0x8
