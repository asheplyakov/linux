...
Source0: kernel-source-%kernel_base_version%kernel_sublevel.tar
...
your system and supports VM-014-0x boards with ELVEES MCom-02 SoC.
...
tar -xf %SOURCE0
%setup -D -T -n kernel-image-%flavour-%kversion-%krelease/kernel-source-%kernel_base_version%kernel_sublevel
%patch0 -p1
...
make dtbs_install INSTALL_DTBS_PATH=%buildroot%dtbs_dir
...
* Mon Apr 13 2020 Evgeny Sinelnikov <sin@altlinux.org> 4.1.27.4-alt1
