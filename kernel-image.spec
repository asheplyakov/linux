...
%changelog
* Mon Sep 05 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.65-alt1
- v5.15.65 (2022-09-05).

* Thu Sep 01 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.64-alt1
- v5.15.64 (2022-08-31).
- Revert "Input: i8042 - enable dumbkbd quirk for HP 15-dy2xxx and
  15s-fq2xxx".

* Thu Aug 25 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.63-alt1
- v5.15.63 (2022-08-25).
- Add Elpitech notebook support (Alexey Sheplyakov).

* Sun Aug 21 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.62-alt1
- v5.15.62 (2022-08-21).

* Wed Aug 17 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.61-alt1
- v5.15.61 (2022-08-17).
- Input: i8042 - enable dumbkbd quirk for HP 15-dy2xxx and 15s-fq2xxx.

* Thu Aug 11 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.60-alt1
- v5.15.60 (2022-08-11).
- ASoC: Intel: sof_es8336: add Kraftway ACCORD S15T DMI info for
  pa-enable lookup quirk.

* Wed Aug 03 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.59-alt1
- v5.15.59 (2022-08-03).
- ASoC: Intel: sof_es8336: add support for more laptop models.

* Sat Jul 30 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.58-alt1
- v5.15.58 (2022-07-29).

* Sat Jul 23 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.57-alt1
- v5.15.57 (2022-07-23).

* Fri Jul 22 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.56-alt1
- v5.15.56 (2022-07-21).

* Fri Jul 15 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.55-alt1
- v5.15.55 (2022-07-15).

* Wed Jul 13 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.54-alt1
- v5.15.54 (2022-07-12).

* Fri Jul 08 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.53-alt1
- v5.15.53 (2022-07-07).

* Sun Jul 03 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.52-alt1
- v5.15.52 (2022-07-02).

* Wed Jun 29 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.51-alt1
- v5.15.51 (2022-06-29).

* Sat Jun 25 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.50-alt1
- v5.15.50 (2022-06-25).

* Wed Jun 22 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.49-alt1
- v5.15.49 (2022-06-22).

* Thu Jun 16 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.48-alt1
- v5.15.48 (2022-06-16).

* Wed Jun 15 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.47-alt1
- v5.15.47 (2022-06-14).

* Thu Jun 09 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.46-alt1
- v5.15.46 (2022-06-09).

* Mon Jun 06 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.45-alt1
- v5.15.45 (2022-06-06).
- altha: Restrict setcap binaries in nosuid mode.
- kernel.perf_event_paranoid=4 by default.

* Mon May 30 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.44-alt1
- v5.15.44 (2022-05-30).

* Thu May 26 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.43-alt1
- v5.15.43 (2022-05-25).

* Wed May 25 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.42-alt1
- v5.15.42 (2022-05-25).

* Wed May 18 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.41-alt1
- v5.15.41 (2022-05-18).

* Sun May 15 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.40-alt1
- v5.15.40 (2022-05-15).

* Wed May 04 2022 Vitaly Chikunov <vt@altlinux.org> 1:5.15.37-alt1
- Update to v5.15.37 (2022-05-01). (Fixes: CVE-2022-1204, CVE-2022-1205,
  CVE-2022-0500, CVE-2022-23222).

* Thu Apr 14 2022 Vitaly Chikunov <vt@altlinux.org> 1:5.15.34-alt1
- Update to v5.15.34 (2022-04-13).
- Apply ES83x6 patchset (nickel).
- Update baikalm-5.15.y patchset to 2022-01-17 (14b0e663071e).

* Fri Apr 08 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.33-alt1
- v5.15.33 (Fixes: CVE-2021-4034)

* Thu Mar 31 2022 Vitaly Chikunov <vt@altlinux.org> 1:5.15.32-alt1
...
* Fri Feb 25 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.25-alt1
- v5.15.25  (Fixes: CVE-2022-0847)

* Fri Feb 11 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.23-alt1
- v5.15.23  (Fixes: CVE-2022-0435)

* Wed Feb 09 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.22-alt1
- v5.15.22

* Mon Feb 07 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.21-alt1
- v5.15.21

* Wed Feb 02 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.19-alt1
- v5.15.19

* Sat Jan 29 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.18-alt1
- v5.15.18

* Fri Jan 28 2022 Kernel Bot <kernelbot@altlinux.org> 1:5.15.17-alt1
- v5.15.17
